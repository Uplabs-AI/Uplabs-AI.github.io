                ...
                <TableCell className="px-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="border-gray-600 text-gray-400 hover:text-white hover:bg-gray-700 px-3 py-1 h-7 text-xs rounded-md"
                    >
                    ...
                    <Button
                      ...
                      variant="ghost"
                      asChild
                      className="text-gray-400 hover:text-white hover:bg-gray-700 p-1 h-7 w-7 rounded-md"
                    >
