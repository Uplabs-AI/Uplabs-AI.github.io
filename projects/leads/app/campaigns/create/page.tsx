...
import { ArrowLeft, Plus, Search, Calendar, Check, CircleAlert, UploadCloud } from "lucide-react"
...
export default function CreateCampaignPage() {
  ...
  const [knowledgeMode, setKnowledgeMode] = useState<"upload" | "text">("upload")
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="rounded-lg border text-card-foreground shadow-sm bg-[#05000E] border-[#1a1a1c]">
              <div className="p-6 space-y-6">
                ...
                <div>
                  <label className="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-sm font-medium text-gray-300 mb-2 block" htmlFor="knowledge-select">Selecciona una base de conocimientos</label>
                  <Select
                    value={formData.selectedKnowledgeId}
                    onValueChange={(value) => handleInputChange("selectedKnowledgeId", value)}
                  >
                    <SelectTrigger id="knowledge-select" className="w-full bg-[#1a1a1c] border-[#374151] text-white">
                      <SelectValue placeholder="Selecciona una base de conocimientos" />
                    </SelectTrigger>
                    <SelectContent className="bg-[#1a1a1c] border-[#374151] text-white">
                      {knowledgebase.length === 0 ? (
                        <SelectItem value="" disabled>No hay bases de conocimientos disponibles</SelectItem>
                      ) : (
