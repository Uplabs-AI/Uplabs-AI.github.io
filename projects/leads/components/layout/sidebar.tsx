...
import { BarChart3, Users, ClipboardList, Settings, Contact, LayoutDashboard, LogOut, ExternalLink, ChevronDown, CreditCard, TrendingUp, Calendar } from "lucide-react"
...
export function Sidebar() {
  ...
  return (
    <div className="flex flex-col h-full w-64 flex-shrink-0 bg-[#000000] border-r border-border transition-all duration-200">
      <div className="p-4">
        <div className="text-2xl font-bold text-white">LEAD</div>
      </div>
                      ...
                      {item.subItems.map((subItem) => (
                        <Link
                          ...
                          className={cn(
                            ...
                            ((subItem.href === "/dashboard" && pathname === "/dashboard") ||
                              (subItem.href === "/settings" && pathname === "/settings") ||
                              (subItem.href !== "/dashboard" && subItem.href !== "/settings" && (pathname === subItem.href || pathname.startsWith(`${subItem.href}/`))))
