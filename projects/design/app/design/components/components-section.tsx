  ...
  const renderBadgesSection = () => (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        {/* Chips estilo dashboard */}
        <div>
          <h3 className="text-xl font-semibold text-white mb-4">Chips / Status Pills</h3>
          <div className="flex flex-wrap gap-3 items-center">
            {/* Verde */}
            <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ backgroundColor: 'rgba(34,197,94,0.1)', color: 'rgb(34,197,94)', borderColor: 'rgba(34,197,94,0.2)' }}>Llamada</div>
            {/* Azul */}
            <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ backgroundColor: 'rgba(59,130,246,0.1)', color: 'rgb(59,130,246)', borderColor: 'rgba(59,130,246,0.2)' }}>Mensaje</div>
            {/* Morado */}
            <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ backgroundColor: 'rgba(94,23,235,0.1)', color: 'rgb(94,23,235)', borderColor: 'rgba(94,23,235,0.2)' }}>Agente IA</div>
            {/* Naranja */}
            <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ backgroundColor: 'rgba(251,191,36,0.1)', color: 'rgb(251,191,36)', borderColor: 'rgba(251,191,36,0.2)' }}>Pendiente</div>
            {/* Rojo */}
            <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ backgroundColor: 'rgba(239,68,68,0.1)', color: 'rgb(239,68,68)', borderColor: 'rgba(239,68,68,0.2)' }}>Error</div>
          </div>
        </div>

        {/* Botón estilo badge principal */}
        <div className="mt-8">
          <h3 className="text-xl font-semibold text-white mb-4">Badge Button</h3>
          <button className="w-full flex items-center px-3 py-2 text-sm rounded-md transition-all duration-200 bg-[#5E17EB] text-white shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-tag h-4 w-4 mr-3"><path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"></path><circle cx="7.5" cy="7.5" r=".5" fill="currentColor"></circle></svg>
            Badges
          </button>
        </div>
      </div>
