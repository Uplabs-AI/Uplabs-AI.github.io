...
export function StatsCard({ title, value, percentChange, icon, variant = "default" }: StatsCardProps) {
  ...
  return (
    <Card className={cn("border border-[#1a1a1c] rounded-xl", getVariantStyles())}>
